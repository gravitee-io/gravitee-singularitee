 ...
 * {@link ToolCallExtractor}'s built-ins, so dialect knowledge stays in one
 * place.
 */
public interface ToolMarkerResidue {
  /** Whether {@code output} contains this dialect's leaked tool-call machinery. */
  boolean isPresent(String output, TagConfig toolTags);
}
