 ...
 * class only binds the llama.cpp delegate type.
 *
 * <p>This class and {@link LlamaCppRerankerFactory} are the <strong>only</strong>
 * files permitted to import {@code gravitee-inference-llama-cpp} reranker types.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class LlamaCppRerankerEngine extends AbstractRerankerEngine<LlamaCppRerankerModel> {

  LlamaCppRerankerEngine(LlamaCppRerankerModel delegate, Vertx vertx) {
