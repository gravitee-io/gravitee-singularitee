...
/**
 * Unit tests for {@link TemplateContextHelper}'s Struct conversion and step
 * context merging.
 *
 ...
 * disables the bypass.
 */
class TemplateContextHelperTest {
  ...
  class StructRoundTrip {
    ...
    void boolean_false_survives_round_trip_as_boolean() {
      ...
      Map<String, Object> out = TemplateContextHelper.structToMap(
        TemplateContextHelper.mapToStruct(in)
      );
    ...
    void boolean_true_survives_round_trip_as_boolean() {
      Map<String, Object> out = TemplateContextHelper.structToMap(
        TemplateContextHelper.mapToStruct(Map.of("enable_thinking", Boolean.TRUE))
      );
    ...
    void string_false_stays_a_string_not_a_boolean() {
      ...
      Map<String, Object> out = TemplateContextHelper.structToMap(
        TemplateContextHelper.mapToStruct(Map.of("enable_thinking", "false"))
      );
    ...
    void numbers_round_trip_as_double() {
      ...
      Map<String, Object> out = TemplateContextHelper.structToMap(
        TemplateContextHelper.mapToStruct(Map.of("max_loops", 3))
      );
  ...
  class MergeStepContext {
    ...
    void boolean_false_is_merged_as_boolean() {
      ...
      TemplateContextHelper.mergeStepContext(ctx, struct);
    ...
    void null_or_empty_struct_is_a_no_op() {
      ...
      TemplateContextHelper.mergeStepContext(ctx, null);
      TemplateContextHelper.mergeStepContext(ctx, Struct.getDefaultInstance());
