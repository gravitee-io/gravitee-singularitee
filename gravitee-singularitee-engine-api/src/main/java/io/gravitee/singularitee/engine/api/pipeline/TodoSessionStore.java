...
public final class TodoSessionStore extends CacheBackedStore<TodoSessionStore.SessionPlan> {
  ...
  public static List<SessionTodo> toSessionTodos(List<PipelineContext.TodoItem> todos) {
    return todos
      .stream()
  ...
  public static List<PipelineContext.TodoItem> toTodoItems(List<SessionTodo> todos) {
    return todos
      .stream()
      .map(t ->
