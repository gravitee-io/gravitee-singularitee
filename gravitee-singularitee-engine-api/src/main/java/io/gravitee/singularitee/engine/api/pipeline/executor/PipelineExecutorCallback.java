...
/**
 * Executes a pipeline (local or remote) reactively; a sub-pipeline step runs the nested
 * pipeline through one of these. Completes when the sub-pipeline finishes.
 *
