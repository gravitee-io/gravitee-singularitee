...
/**
 * The {@code sub_pipeline} step plugin: a core step, always shipped.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class SubPipelineStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.SUB_PIPELINE;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new SubPipelineStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    return new SubPipelineStepExecutor(
      services.executionContext(),
      services.subPipelineCallbacks()
    );
  }
}
