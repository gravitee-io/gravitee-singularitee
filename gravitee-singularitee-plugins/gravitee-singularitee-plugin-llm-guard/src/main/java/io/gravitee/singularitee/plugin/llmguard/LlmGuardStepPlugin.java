...
/**
 * The {@code llm_guard} step plugin: LLM-as-judge safety check.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class LlmGuardStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.LLM_GUARD;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new LlmGuardStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    return new LlmGuardStepExecutor(services.executionContext(), services.templateRenderer());
  }
}
