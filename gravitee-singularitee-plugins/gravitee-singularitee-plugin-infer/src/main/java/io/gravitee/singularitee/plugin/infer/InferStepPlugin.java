...
/**
 * The {@code infer} step plugin.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class InferStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.INFER;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new InferStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    return new InferStepExecutor(
      services.executionContext(),
      services.templateRenderer(),
      services.chatTemplateRenderer()
    );
  }
}
