...
/**
 * The {@code embed} step plugin.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class EmbedStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.EMBED;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new EmbedStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    return new EmbedStepExecutor(services.executionContext());
  }
}
