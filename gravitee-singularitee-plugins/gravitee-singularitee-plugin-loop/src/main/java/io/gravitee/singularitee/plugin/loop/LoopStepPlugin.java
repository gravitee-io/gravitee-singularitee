...
/**
 * The {@code loop} step plugin.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class LoopStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.LOOP;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new LoopStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    return new LoopStepExecutor(services.templateRenderer());
  }
}
