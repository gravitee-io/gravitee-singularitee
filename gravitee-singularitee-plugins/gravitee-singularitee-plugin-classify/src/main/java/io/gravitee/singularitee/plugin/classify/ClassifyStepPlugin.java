...
/**
 * The {@code classify} step plugin.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class ClassifyStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.CLASSIFY;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new ClassifyStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    return new ClassifyStepExecutor(services.executionContext());
  }
}
