...
/**
 * The {@code regex_guard} step plugin: model-free pattern guard with optional redaction.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class RegexGuardStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.REGEX_GUARD;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new RegexGuardStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    return new RegexGuardStepExecutor(services.templateRenderer());
  }
}
