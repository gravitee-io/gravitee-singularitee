...
/**
 * The {@code guard} step plugin: classifier-backed input check.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class GuardStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.GUARD;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new GuardStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    return new GuardStepExecutor(services.executionContext(), services.templateRenderer());
  }
}
