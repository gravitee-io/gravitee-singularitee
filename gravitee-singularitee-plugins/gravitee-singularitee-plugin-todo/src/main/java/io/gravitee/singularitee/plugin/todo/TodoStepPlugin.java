...
/**
 * The {@code todo} step plugin: a core step, always shipped.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class TodoStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.TODO;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new TodoStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    // The session store is optional: a client-side executor has none.
    return new TodoStepExecutor(services.todoSessionStore());
  }
}
