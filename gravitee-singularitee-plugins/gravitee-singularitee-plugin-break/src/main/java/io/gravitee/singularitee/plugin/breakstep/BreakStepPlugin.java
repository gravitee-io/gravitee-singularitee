...
/**
 * The {@code break} step plugin.
 *
 * @author Rémi SULTAN (remi.sultan at graviteesource.com)
 * @author GraviteeSource Team
 */
public final class BreakStepPlugin implements StepExecutorPlugin {

  @Override
  public String type() {
    return StepTypes.BREAK;
  }

  @Override
  public StepConfigCodec<?> codec() {
    return new BreakStepCodec();
  }

  @Override
  public StepExecutor<?> create(StepExecutorServices services) {
    return new BreakStepExecutor();
  }
}
